...
- Highlighting or applying a suggestion could act on the wrong document after a check was
  re-run on a previously checked file. The most recently checked document is now always used.
